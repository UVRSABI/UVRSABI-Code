...
#!/usr/bin/env python
# conda init bash
cd ./DistanceModuleInBetweeenMode
results_path=../DistanceModuleInBetweeenModeResults
...
echo "Done!!"
cd ./DistanceModuleInBetweenMode
echo "Calculations Started"
chmod +x InBetweeenMode.py
python3 InBetweeenMode.py --logpath $2
echo "Done!!"
